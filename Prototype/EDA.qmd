...
create_comprehensive_plots <- function(data) {
  ...
  all_vars <- c("BasicSanitation", "BasicWater", "OpenDefecation", "WaterStress", 
                "WaterProductivity", "HepatitisA", "Diarrhea", "Typhoid")
...
save_plots <- function(plot_list, output_dir = "comparison_plots") {
