...
flowchart TD
  subgraph "Water Accessibility and Safety Analysis"
    A(Typhoid Outbreak 2000-2022 & WB Sanitation Dataset) --> B(Read Input)
...
-   Merge Typhoid outbreak 2000 - 2022 with World Bank sanitation statistic 2000 - 2023 for understanding the relationship between waterborne disease and access to unsafe water source  
