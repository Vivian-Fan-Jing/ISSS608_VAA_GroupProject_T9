...
flowchart TD
  subgraph "Water Accessibility and Safety Analysis"
    A(OSF Typhoid outbreak & World Bank World WDI) --> B(Read Input)
...
-   Merge Typhoid outbreak 2000 - 2022 from Center for Open Science (OSF) with World Development indicator (WDI) from World Bank 2000 - 2023 for understanding the relationship between waterborne disease and access to unsafe water source  
