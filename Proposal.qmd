...
To meet [Sustainable Development Goal 6 (SDG 6)](https://sdgs.un.org/goals/goal6) targets, the global rate of progress must accelerate significantly — 6x for drinking water, 5x for sanitation, and 3x for hygiene. Achieving these targets would save **829,000 lives** annually, the number of people who currently die each year from disease directly linked to unsafe water, inadequate sanitation and poor hygiene.
